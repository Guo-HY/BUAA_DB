...
![image-20221221225804017](pictures/image-20221221225804017.png)
...
![image-20221221224116347](pictures/image-20221221224116347.png)

#### 修改头像

用户可以通过点击选择文件，选择自己喜欢的照片作为头像

![image-20221221225744786](pictures/image-20221221225744786.png)

选中后，点击确认添加，将新头像上传

![image-20221221224620417](pictures/image-20221221224620417.png)

我们还实现了将图片进行风格迁移，将原图像进行一定处理后生成用户头像，增强了网站的趣味性

![image-20221221225529426](pictures/image-20221221225529426.png)
...
![image-20221221225941891](pictures/image-20221221225941891.png)

![image-20221221230144322](pictures/image-20221221230144322.png)

![image-20221221230211869](pictures/image-20221221230211869.png)

##### （2）增加自定义Tag

![image-20221221230355227](pictures/image-20221221230355227.png)

![image-20221221230509499](pictures/image-20221221230509499.png)

![image-20221221230557965](pictures/image-20221221230557965.png)

#### 修改个人信息

![image-20221221230657289](pictures/image-20221221230657289.png)

![image-20221221230736134](pictures/image-20221221230736134.png)

![image-20221221230809441](pictures/image-20221221230809441.png)

提示修改成功

![image-20221221231826343](pictures/image-20221221231826343.png)

![image-20221221231839985](pictures/image-20221221231839985.png)

### 漂流瓶

![image-20221218220006839](pictures/image-20221218220006839-1671715226819-1.png)
...
- 中间的三个按键，分别问
  - 我发出的漂流瓶
  - 我收到的漂流瓶回复
    - ![image-20221218221821313](pictures/image-20221218221821313-1671715226820-2.png)
...
![image-20221221223759883](pictures/image-20221221223759883.png)

用户也可以**自行创建**活动

![image-20221221221054729](pictures/image-20221221221054729.png)

该页面展示目前已有活动的详细信息，用户可以通过点击蓝色文字**创建活动**

显示**活动创建页面**如下

![image-20221221221227109](pictures/image-20221221221227109.png)

用户分别在对应框中分别填入**活动名称**

![image-20221221223208179](pictures/image-20221221223208179.png)

选择**活动区域**

![image-20221221223144508](pictures/image-20221221223144508.png)

选择**活动开始日期**和**活动结束日期**

![image-20221221223317256](pictures/image-20221221223317256.png)

选择**活动性质**

![image-20221221223344850](pictures/image-20221221223344850.png)

填写**活动描述**

最后点击**立即创建**按钮后，进一步点提示中的**确定**完成创建

![image-20221221223511659](pictures/image-20221221223511659.png)

显示**提交成功**提示

![image-20221221223627385](pictures/image-20221221223627385.png)
